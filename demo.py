...
def main():  
    ES_URL = "https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.9.2-linux-x86_64.tar.gz"
#     ES_PATH = Path(__file__).parent / "ES"
#     startES(ES_URL, ES_PATH)
    startES(ES_URL)
